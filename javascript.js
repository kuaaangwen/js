...
{question: "Which product will be formed when a primary amine is reacted with HCl?", answers: {A: "Secondary amine", B: "Amide", C: "Alkylammonium salt", D: "No reaction"}, correctAnswer: "C", topic: "Carboxylic Acids and Derivatives", type: "choice", questionID: 20},
...
{question: "Which product(s) will be formed when a primary amide is heated under reflux with dilute H<sub>2</sub>SO<sub>4</sub>?", answers: {A: "Primary alkylammonium salt", B: "Secondary alkylammonium salt ", C: "Ammonium", D: "Carboxylic acid", }, correctAnswer: {A: false, B: false, C: true, D: true}, topic: "Nitrogen Compounds", type: "checkbox", questionID: 121},
{question: "Which product(s) will be formed when a secondary amide is heated under reflux with dilute H<sub>2</sub>SO<sub>4</sub>?", answers: {A: "Primary alyklammonium salt", B: "Secondary alkylammonium salt ", C: "Ammonium", D: "Carboxylic acid", }, correctAnswer: {A: true, B: false, C: false, D: true}, topic: "Nitrogen Compounds", type: "checkbox", questionID: 122},
...
{question: "Which product(s) will be formed when a carboxylic acid is reacted with PCl<sub>3</sub>?", answers: {A: "Acyl chloride", B: "HCl", C: "H<sub>3</sub>PO3", D: "POCl<sub>3</sub>", }, correctAnswer: {A: true, B: false, C: true, D: false}, topic: "Carboxylic Acids and Derivatives", type: "checkbox", questionID: 125},
{question: "Which product(s) will be formed when a carboxylic acid is reacted with PCl<sub>5</sub>?", answers: {A: "Acyl chloride", B: "HCl", C: "H<sub>3</sub>PO3", D: "POCl<sub>3</sub>", }, correctAnswer: {A: true, B: true, C: false, D: true}, topic: "Carboxylic Acids and Derivatives", type: "checkbox", questionID: 126},
...
{question: "Which product will be formed when an alcohol is reacted with PCl<sub>3</sub>?", answers: {A: "Chloroalkane", B: "HCl", C: "H<sub>3</sub>PO3", D: "POCl<sub>3</sub>", }, correctAnswer: {A: true, B: false, C: true, D: false}, topic: "Hydroxy Compounds", type: "checkbox", questionID: 132},
{question: "Which product will be formed when an alcohol is reacted with PCl<sub>5</sub>?", answers: {A: "Chloroalkane", B: "HCl", C: "H<sub>3</sub>PO3", D: "POCl<sub>3</sub>", }, correctAnswer: {A: true, B: true, C: false, D: true}, topic: "Hydroxy Compounds", type: "checkbox", questionID: 133},
...
{question: "Which of the following sets of reagent and condition are suitable to turn an amine into an amide?", answers: {A: "acyl chloride, r.t.p", B: "acyl chloride(aq)", C: "carboxylic acid, heat", D: "carboxylic acid, r.t.p", }, correctAnswer: {A: true, B: false, C: false, D: false}, topic: "Nitrogen Compounds", type: "checkbox", questionID: 157},
{question: "Which of the following sets of reagent and condition are suitable to turn an amine into a salt?", answers: {A: "HCl(aq)", B: "acyl chloride, heat", C: "carboxylic acid(aq), r.t.p", D: "ester", }, correctAnswer: {A: true, B: false, C: true, D: false}, topic: "Nitrogen Compounds", type: "checkbox", questionID: 158},
...
{question: "Which of the following sets of reagent and condition are suitable to turn an alcohol into an alkene?", answers: {A: "H<sub>2</sub>SO<sub>4</sub>(aq), heat", B: "Excess H<sub>2</sub>SO<sub>4</sub>(conc), 1<sub>7</sub>0 degrees", C: "H<sub>3</sub>PO<sub>4</sub>(aq)", D: "Al<sub>2</sub>O<sub>3</sub>, heat", }, correctAnswer: {A: false, B: true, C: false, D: true}, topic: "Hydroxy Compounds", type: "checkbox", questionID: 186},
...
{question: "Which of the following sets of reagent and condition are suitable to turn a phenol into <sub>4</sub>-nitrophenol?", answers: {A: "HNO<sub>3</sub>(conc), H<sub>2</sub>SO<sub>4</sub>(conc), heat", B: "Dilute HNO<sub>3</sub>", C: "Conc HNO<sub>3</sub>", D: "HNO<sub>3</sub>(conc), H<sub>2</sub>SO<sub>4</sub>(conc), cold", }, correctAnswer: {A: false, B: true, C: false, D: false}, topic: "Hydroxy Compounds", type: "checkbox", questionID: 199},
